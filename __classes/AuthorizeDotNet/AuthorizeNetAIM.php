 ...
 * @subpackage AuthorizeNetAIM
 */
class AuthorizeDotNet_AuthorizeNetAIM extends AuthorizeDotNet_AuthorizeNetRequest
{
    ...
    public function setField($name, $value)
    {
        if ($this->verify_x_fields) {
            if (in_array($name, $this->_all_aim_fields)) {
                ...
                throw new AuthorizeDotNet_AuthorizeNetException("Error: no field $name exists in the AIM API.
    ...
    {
        return new AuthorizeDotNet_AuthorizeNetAIMResponse($response, $this->_x_post_fields['delim_char'], $this->_x_post_fields['encap_char'], $this->_custom_fields);
    }
 ...
 * @subpackage AuthorizeNetAIM
 */
class AuthorizeDotNet_AuthorizeNetAIMResponse extends AuthorizeDotNet_AuthorizeNetResponse
{
