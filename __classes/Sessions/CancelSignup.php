...
class Sessions_CancelSignup extends BaseClass
{
    ...
    public $Force_Not_Cancellable           = false;
    
    # EMAIL SETTINGS
    # ======================================================
    public $Send_Email_Instructor           = true;
    public $Send_Email_Customer             = true;
    public $Send_Email_BCC_Administrator    = false;
    ...
    # ======================================================
    public $WH_ID                           = 0;
    public $Refund_Credits_On_Cancellation  = true;
    ...
    public $Script_Location                 = '';   ###"/office/sessions/cancel";
    ...
    public function Execute()
    {
        ...
        if ($this->Sessions_Id != 0) {
            $cancellable = (!$this->Approved_To_Delete) ? $this->CheckIfSessionCanBeCancelled() : true;
            
            
            echo "<br /><br />ABOUT TO CANCEL A CLASS SIGNUP";
            echo "<br />Sessions_Id ===> " . $this->Sessions_Id;
            
            
            if ($cancellable) {
                echo "<br /><br />SESSION IS CANCELLABLE";
                echo "<br /><br /> NOT ACTUALLY GONNA DELETE - BECUASE NOT TESTED YET";
                $cancel_result = $this->DeactivateSingleSession($this->Sessions_Id);
            } else {
                echo "<br /><br /><div style='color:#990000;'>SESSION IS NOT CANCELLABLE</div>";
            }
        }
