...
{
    public $Show_Sessions_Id            = false;
    
    public $Use_Fake_Course_Data        = false;    // Create fake events for the instructor - don't pull from database
    public $Return_Page                 = null;

    public $Is_Instructor               = false;
    
    public $Show_Booked_Sessions        = false;
    public $Show_Locked_Sessions        = true;
    public $Show_Non_Display_Sessions   = false;
    public $Show_Inactive_Sessions      = false;
    public $Show_Sessions_Before_Today  = false;    // Will show sessions before today - ONLY in the search BY DATE method
    public $Show_Hidden_Instructors     = false;
    ...
    public function SearchByInstructor_MenuLeft() 
    {
        ...
        $output = "
            <div style='text-align:center;'>
                <br /><br />
                <div class='orange left_header lowercase'>search by instructor</div>
    ...
    public function GetInstructors($RETURN=false)
    {
        ...
        if ($records) {
            foreach ($records as $record) {
                ...
                $name_first         = ($record['first_name'] != '') ? ucwords(strtolower($record['first_name'])) : '';
...
SCRIPT;
    ...
    public function SearchByDate_MenuLeft() 
    {
        ...
        $output = "
            ...
            <center>
                <br /><br />
                <div class='orange left_header lowercase'>search by date</div>
                <br /><br />
                <div id='cal_date_search'></div>
                <br /><br />
