...
class Profile_HelpCenter
{
    ...
    public $Use_Display_All_Category        = true;
    ...
    public function Execute()
    {
        ...
        #$eq_InstructorProfileEdit       = EncryptQuery("class=Profile_ContactInformation;v1=1000051");
        #$link                      = "<a href='#' onclick=\"top.parent.appformCreateOverlay('Edit Your Public Profile', getClassExecuteLinkNoAjax('{$eq_InstructorProfileEdit}'), 'apps'); return false;\">";
