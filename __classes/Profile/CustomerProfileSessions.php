...
class Profile_CustomerProfileSessions extends BaseClass
{
    ...
    public $Show_Timezone_Conversion        = false;
    ...
    public $Time_Show_Launch_Button         = 7200; //120 mins = 7200 seconds
    
    public $Is_Instructor                   = false;
    
    public $Create_Testing_Session          = false;    // If set to TRUE will output a fake session in the "Today's Sessions" area
    public $Echo_Records_Array              = false;
    ...
    public $show_session_id                     = false;
    public $show_launch_session                 = true;
    public $show_test_session                   = true;
    public $show_ical                           = true;
    public $show_user_rate_session              = true;
    public $show_user_cancel_session            = true;
    public $show_instructor_rate_session        = true;
    public $show_instructor_upload_video        = true;
    public $show_session_details                = true;
    public $show_intake_form                    = true;
    public $show_admin_datetime                 = false;
    public $show_instructor_profile			    = true;
    
    public $Verify_Instructor_Video_Exists      = true;
    
    public $show_sessions_today                 = true;
    public $show_sessions_future                = true;
    public $show_sessions_past                  = true;
	

    public $Have_Session_Today                  = false;
    ...
    private $User_Rated_Current_Session         = false;
    private $Instructor_Rated_Current_Session   = false;
    
    
    
    public $Format_Session_Customer_Not_Rated   = false;
