<?php
class Website_TherapyFormCustomer extends BaseClass
{
    public $TESTING                             = true; //turns on testing variables
    public $TESTING_Add_Credits_To_Customer     = 15;
        ...
        switch ($step) {
            ...
            case 'start':
                ...
                $this->Current_Step_Output = "
                    [T~USER_REGISTRATION_INSTRUCTIONS_START]
                    <br /><br />
                    <div>
            ...
            case 'create_account':
                ...
                $OBJ_ACCOUNT = new Profile_FormTherapyIntake();
