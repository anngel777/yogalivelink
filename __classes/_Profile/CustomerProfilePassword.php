<?php
class Profile_CustomerProfilePassword extends BaseClass
{
    ...
    public function SetFormArrays()
    {
        ...
        $info .= ($this->require_uppercase) ? '<br />At least one <b>uppercase letter</b> is required.' : '';
        $info .= ($this->require_lowercase) ? '<br />At least one <b>lowercase letter</b> is required.' : '';
        $info .= ($this->require_numbers) ? '<br />At least one <b>number</b> is required.' : '';
        $info .= ($this->require_symbols) ? '<br />At least one <b>symbol</b> is required.' : '';
