...
class Chat_Chat //extends BaseClass
{
    ...
    public function OutputChatStatusBox()
    {
        ...
        $message .= ($online) ? "<br />[<a href=\"#\" onclick=\"javascript:window.open('/office/chat/chat_user;resize=true','blank','toolbar=no,width=250,height=250,location=no')\">CLICK HERE</a>]" : '';
        //$message .= "<br /><br /><span onclick=\"return openPerfectPopup(300,'Title','Contents','/office/chat/chat_user')\">new window</span>";
    
        $output = "
        <div class='touchpoint_outter_wrapper' style='width:200px;'>
        <div class='touchpoint_inner_wrapper'>
            <div class='col touchpoint_icon'>
                <img src='{$this->ico_chat}' border='0' height='50' alt='' />
            </div>
            <div class='col'>
