...
class Profile_CreateAccountCustomerAdministrator extends BaseClass
{
    ...
    public function UserSignupSpecialSubmitButton() 
    {
        ...
        #$onclick 	= "javascript:document.db_edit_form.submit();";
        
        #$onclick 	= "";
        #$onclick 	.= "this.value='{$FORM_VAR['submit_click_text']}';";
        #$onclick 	.= " document.db_edit_form.submit();";
    ...
    public function SetFormArrays()
    {
        ...
        $agree_link         = "<div style='font-size:10px;'><a href='http://yoga.whhub.com/terms_and_conditions' target='_new'>Click to View Terms and Conditions (opens in new window)</a></div>";
        /*
        $agree_link         = "
