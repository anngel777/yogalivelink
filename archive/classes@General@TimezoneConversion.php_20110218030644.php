...
{
    # ====================================================================
    # CLASS ::  Utilizes PHP 5.2 functions to do a timezone conversion. 
    #           This class DOES consider daylight savings time.
    # ====================================================================
    ...
    public function TestConversion()
    {
        ...
        echo "<br />converted_datetime ==> $converted_datetime";
        
        return $converted_datetime;
    }
    
    public function ConvertDateTimeBetweenTimezones($input_date_time, $input_timezone='UTC', $output_timezone='UTC', $output_format='Y-m-d H:i')
    {
        # ====================================================================
        ...
        $input_date_time    = new DateTime($input_date_time, $input_time_zone);
        $output_time_zone   = new DateTimeZone($output_timezone);  
        
        $offset             = $output_time_zone->getOffset($input_date_time);
        $output_date_time   = date($output_format, $input_date_time->format('U') + $offset);
