...
class Chat_TouchpointChatsEmail extends BaseClass
{
    ...
    public $from_name               = "OnlineYoga.com";
    public $from_email              = "OnlineYoga@mailwh.com";
    public $subject_user  		    = 'OnlineYoga.com Chat Log';
    ...
    public function EmailChatToUser()
    {
        ...
        $form = <<<FORM
            ...
            <div><br />Click the button below to have a copy of this chat session emailed to you.</div>
            <br /><br />
