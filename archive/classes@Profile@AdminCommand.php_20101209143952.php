...
class Profile_AdminCommand
{
    ...
    public function GetCommonActions()
    {
        ...
        $link_6     = "/office/dev_richard/class_execute;class=Sessions_UpdateWithUTCDate";
        $script_6   = "top.parent.appformCreate('Window', '{$link_6}', 'apps'); return false;";
        
        $link_7     = "/office/dev_richard/class_execute;class=DevRichard_TestSendEmail";
        $script_7   = "top.parent.appformCreate('Window', '{$link_7}', 'apps'); return false;";
        ...
        <br /><br />
        <div class='btn_actions'><a href='#' onclick=\"{$script_6}\">UPDATE SESSIONS WITH UTC TIMEZONES</a></div>
        <br /><br />
        <div class='btn_actions'><a href='#' onclick=\"{$script_7}\">TEST SEND AN EMAIL MESSAGE</a></div>
        ";
    ...
    public function LoadTabs()
    {
        ...
        $OBJ_SESSION_ANALYSIS               = new Sessions_Analysis();
        ...
        $tab_content_session_analysis       = $OBJ_SESSION_ANALYSIS->Execute(true);
        ...
        if ($this->show_session_analysis)   $OBJ_TABS->AddTab('Session Analysis', "<div class='tab_content_wrapper'>{$tab_content_session_analysis}</div>");
