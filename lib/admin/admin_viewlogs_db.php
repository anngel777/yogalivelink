...
$form_data = "
    ...
    code|<p style=\"text-align:center;\"><a href=\"#\" class=\"editbutton\" 
...
';
    ...
    if (HaveSubmit('MONTHLY_SESSIONS')) {
        ...
        $LOG->OutputSessionArray($MONTH, $result['READ_TYPE'], $result['SHOW_AGENT'], $result['REF_ONLY'], $result['START'], $result['ROWS']);
