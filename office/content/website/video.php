...
AddScript("
    ...
    swfobject.embedSWF('/office/video/faces.swf', 'flashContent', '800', '600', '10.0.0', '/office/video/expressInstall.swf', flashvars, params);
    swffit.fit('flashContent', 800, 600);
");
