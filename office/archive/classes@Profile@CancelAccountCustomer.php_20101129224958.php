        ...
        foreach ($this->sessions as $session) {
            ...
            if (strtotime($session_date) > strtotime($now_date)) {
                ...
                if ($diff_in_hours > $session_cancel_within_time_hrs) {
                    ...
                    $result = $this->DeactivateSingleSession($session['sessions_id']);
                } else {
                    # session is occurring too close - cannot cancel without additional authorization
                    echo "<br /><br />SESSION CANNOT BE CANCELED BECAUSE THE COURSE HAPPENS TOO CLOSE IN THE FUTURE [$diff_in_hours > $session_cancel_within_time_hrs]";
                }
            } else {
