...
class Translation_Translations extends BaseClass
{
    ...
    public $Reload_Word_Array                   = false; # if set to true - will cause language to reload - it then toggles back to false
...
#==================================================================================================
    ...
    public function TranslateText($TEXT, $LANGUAGE, $TRANSID_FLAG='')
    {
        ...
        if (!$TRANSID_FLAG || strtoupper($TRANSID_FLAG) == 'ALL')
        {
            ...
            if (($this->Word_Array_Language != $LANGUAGE) || $this->Reload_Word_Array) {
                $this->Word_Array           = $this->LoadTranslations($LANGUAGE);
                $this->Word_Array_Language  = $LANGUAGE;
                $this->Reload_Word_Array    = false; # toggle the reload variable back to false so language won't reload again
            }
    ...
    function LoadTranslations($LANGUAGE)
    {
        ...
        $RESULTS = $this->SQL->GetArrayAll(array(
