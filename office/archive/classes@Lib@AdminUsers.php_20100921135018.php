...
class Lib_AdminUsers extends Lib_BaseClass
{
    ...
    public function  __construct()
    {
        ...
        $this->Index_Name = 'admin_users_id';

        $this->Flash_Field = 'admin_users_id';

        $this->Default_Sort  = 'admin_users_id';  // field for default table sort
        ...
        // if ($this->GetFlag('no_password')) {
            // unset($this->Field_Titles['password']);
        // }

        $this->Default_Fields = 'email_address,first_name,last_name,super_user,company_name';
    ...
    public function SetFormArrays()
    {
        ...
        $base_text_array = "
            ...
            text|Company Name|company_name|N|40|80|$E
            $password|$E
