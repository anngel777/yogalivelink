...
class Store_ViewOrders
{
    ...
    public function Execute($type, $order_number)
    {
        switch ($type) {
            case 'single':
                $this->OutputSingleOrder($order_number);
            break;
            case 'all':
                $this->OutputAllOrders();
            break;
        }
    }
    ...
    public function OutputAllOrders()
    {
        ...
        foreach ($orders as $order) {
            ...
            foreach ($order as $item) {
                ...
                $actions    = "
                    <div><a href='{$view_order_link}'>View Order Details</a></div>
                ...
                <div class='order_table_row'>
                    ...
                    <div class='order_number'><a href='{$view_order_link}'>{$item['order_number']}</a></div>
    ...
    public function AddStyle() 
    {
        ...
        .order_detail_contentboxes {
            float:left;
        }
        
        .order_subcontent_wrapper {
        ...
        .order_detail_description_title {
            font-size:14px;
            font-weight:bold;
        }
        .order_detail_description_description {
            font-size:10px;
            font-weight:normal;
        }
        .col {
