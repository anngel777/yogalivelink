...
class Sessions_RatingsInstructor extends BaseClass
{
    ...
    public function SetFormArrays()
    {
        ...
        $base_array = array(
            ...
            'code|<h3>Thank you for completing this session. Please help us improve our service by answering the following questions:</h3><br /><br />',
            ...
            "hidden|instructor_id|$this->wh_id",
            "info|instructor_id|$this->wh_id",
            

            
            'code|<br /><br />',
            'info||&nbsp;&nbsp;Poor &nbsp;&nbsp;&nbsp; Excellent',
            "radioh|User Skill|user_skill|N|star='star'|$startlist",
            "radioh|User Knowledge|user_knowledge|N|star='star'|$startlist",
