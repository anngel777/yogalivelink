<?php
class Sessions_Search1 extends BaseClass
{
            ...
            //foreach ($date_list as $date) {
                ...
                foreach ($time_list as $time) {
                    ...
                    for ($z=0; $z<$k; $z++){
                        ...
                        $records[$date][$time][$z]['instructor_id']             = 666;
    ...
    public function CreateSchedule()
    {
        ...
        for ($i=0; $i<25; $i++) {
            ...
            if (isset($existing_records[$divID])) {
                ...
                $display_a      = "<b>{$count}</b> {$count_title} AVAILABLE<br /><a href='#' onclick=\"ShowCourseListing('{$divID}')\">[ click to view ]</a>"; //$existing_records[$divID]['data'];
