...
//echo "chat ===> $chat";
    ...
    private function CreateUserChat($code='')
    {
        $content = <<<CONTENT
            <center>
    ...
    private function AddScriptChatWindow()
    {
        ...
        $script = <<<SCRIPT
            ...
            function chat_refresh() {
                ...
                $.getJSON("/office/AJAX/chat/chat_user.php?action=get_chat_content&time="+lastTime+"&code=HS8WDK&currentRows="+existing_rows, function(json) {
                    if(json.length) {
