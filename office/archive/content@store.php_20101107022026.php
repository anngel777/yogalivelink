...
$FORM_VAR['title_template'] = '<div class="formtitle">@:</div>' ."\n";

echo '
<p style="text-align:right;"><a id="button_view_cart" href="#" onclick="return viewShoppingCart();">
<img src="/images/cart.gif" id="cart_image" alt="Cart" border="0" width="22" height="17" /> View Cart</a></p>';



$CATALOG = new Store_YogaStoreCatalog;
