...
class Website_Configuration extends BaseClass
{
    ...
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Manage website configuration for menu and footer area in back-office and display on website',
        );
    ...
    {
        # FUNCTION :: Add site swaps to put this info into the content stream
    ...
    {
        # FUNCTION :: CHeck if user is logged into system
    ...
    {
        # FUNCTION :: Get configurations from the database
        global $PAGE;
