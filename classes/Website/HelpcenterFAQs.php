...
class Website_HelpcenterFAQs extends BaseClass
{
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Manage helpcenter_faqs in back-office and display on website',
        );
        ...
        $this->Field_Titles = array(
            ...
            'type_administrator'    => 'Show To Administrators',
    ...
    public function SetFormArrays()
    {
        ...
        $base_array = array(
            ...
            'checkbox|Show To Administrators|type_administrator||1|0',
    ...
    {
        # FUNCTION :: Get a single FAQ from the database
