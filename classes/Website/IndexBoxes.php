...
class Website_IndexBoxes extends BaseClass
{
    ...
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Manage website index page boxes in back-office and dispaly on website',
        );
    ...
    {
        # FUNCTION :: Get index paged boxes and output as divs
    ...
    {
        # FUNCTION :: Get index paged boxes and output as table
