...
class Email_EmailContentTemplates extends BaseClass
{
    ...
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Create and manage email_content_templates - default text in email - will have database swaps in it',
        );
    ...
    public function SetFormArrays()
    {
        ...
        if (Post('SEND_TEST')) {
            ...
            $email_template_id      = $this->Edit_Id;
            ...
            */
            ...
            #echo '<br /><br />'.ArrayToStr($msg_array).'<br /><br />';
