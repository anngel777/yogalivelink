<?php
class Email_EmailQSend extends BaseClass
{
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Manage email_q_bounced in back-office -> tracks email blasts that sucessfully sent to receiver',
        );

        $this->Table                = 'email_q_send';
        $this->Add_Submit_Name      = 'EMAIL_Q_SEND_SUBMIT_ADD';
        $this->Edit_Submit_Name     = 'EMAIL_Q_SEND_SUBMIT_EDIT';
        $this->Index_Name           = 'email_q_send_id';
        $this->Flash_Field          = 'email_q_send_id';
        $this->Default_Where        = '';  // additional search conditions
        $this->Default_Sort         = 'email_q_send_id';  // field for default table sort
        $this->Default_Fields       = 'email_setups_id,from_name,from_email,to_name,to_email,cc_list,bcc_list,subject,content_html,content_text,attachment_1,attachment_2,attachment_3';
        $this->Unique_Fields        = '';
