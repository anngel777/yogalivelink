...
class Images_UploadingScaling
{
    ...
    public function  __construct()
    {
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Allows an image file to be uploaded to FTP server and scaled',
        );
        ...
        $this->thumb_width_preview      = $GLOBALS['INSTRUCTOR_PICTURE_WIDTH_SIZING'];
        $this->thumb_height_preview     = $GLOBALS['INSTRUCTOR_PICTURE_HEIGHT_SIZING'];
...
SCRIPT;
    ...
    {
        # FUNCTION :: Resize the large version of image
    ...
    {
        # FUNCTION :: Resize the thumbnail version of image
