 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetCustomer
{
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetAddress
{
    public $firstName;
    public $lastName;
    public $company;
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetPaymentProfile
{
    ...
    {
        $this->billTo = new AuthorizeDotNet_AuthorizeNetAddress;
        $this->payment = new AuthorizeDotNet_AuthorizeNetPayment;
    }
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetPayment
{
    public $creditCard;
    public $bankAccount;
    ...
    public function __construct()
    {
        $this->creditCard = new AuthorizeDotNet_AuthorizeNetCreditCard;
        $this->bankAccount = new AuthorizeDotNet_AuthorizeNetBankAccount;
    }
}
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetTransaction
{
    public $amount;
    public $tax;
    public $shipping;
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetLineItem
{
    public $itemId;
    public $name;
    public $description;
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetCreditCard
{
    public $cardNumber;
 ...
 * @subpackage AuthorizeNetCIM
 */
class AuthorizeDotNet_AuthorizeNetBankAccount
{
    public $accountType;
 ...
 */
class AuthorizeDotNet_AuthorizeNetSubscription
{
