...
class Chat_RatingsChat extends BaseClass
{
    ...
    public $IsTesting               = true;     // TRUE = in testing mode - don't know why set to true - USED ???
    public $Show_Array              = false;    // TRUE = dump out database arrays
    ...
    public function SetFormArrays()
    {
        ...
        $base_array = array(
            ...
            'code|<h3>It has been a pleasure to provide services to you. Please help us improve our service by answering the following questions:</h3>',
            
            "form|$this->Action_Link|post|db_edit_form",
            'code|<div style="font-size:14px; border:1px solid #ccc; background-color:#efefef; padding:10px;">',
                ...
                'code|<br /><br />',
                "textarea|Comments|notes|N|4|5",
            'code|</div>',
        );

        if ($this->Action == 'ADD') {
            //$base_array[] = "submit|Add Record|$this->Add_Submit_Name";
            $base_array = BaseArraySpecialButtons($base_array, $this->Add_Submit_Name, 'Save Review', '', true, false);
            $base_array[] = 'endform';
