...
class Chat_Chat
{
    public $Show_Instructions               = false;    // TRUE = output instructions for using chat - DEVELOPMENT ONLY
    ...
    # ---------- MESSAGES OUTPUT TO CHAT WINDOW ----------
    ...
    private $LockRecordOnAdminOpen      = false;        // TRUE = locks the session when an admin opens - stops other admins from entering chat
    
    # ---------- DISPLAY SETTINGS ----------
    private $LoadCommonResponses            = true;     // TRUE = Show the "common responses" section - admins only
    private $LoadUserInformation            = true;     // TRUE = Show the "user information" section - admins only
    private $LoadUserActualInformation      = false;    // TRUE = Show the "real user information" section - admins only
    private $LoadClassVersion               = false;    // TRUE = Show the class version
    ...
    public $Chat_Status_Online              = false;    // Will hold the status of chat being online or not
    ...
    {
        # FUNCTION :: Determine if any admins are currently online
        ...
        if ($this->Show_Query) { echo "<br />Db_Last_Query ===> " . $this->SQL->Db_Last_Query; }
    ...
    {
        # FUNTION :: Modify the URLto have additional GET variables
    ...
    {
        # FUNCTION :: Output the box showing if chat is online
    ...
    {
        # FUNCTION :: Output the box showing if chat is online - different format
    ...
    {
        # FUNCTION :: Process AJAX calls for chat
    ...
    {
        # FUNCTION :: Initialize a chat window for a customer user
    ...
    {
        # FUNCTION :: Output the actual HTML for a chat window for a customer user
...
CONTENT;
    ...
    {
        # FUNCTION :: LOAD THE CHATS CLASS - AND SHOW FORM FOR USER CHAT CREATION
    ...
    {
        # FUNCTION :: Output the actual HTML for a chat window for an instructor
...
CONTENT;
    ...
    {
        # FUNCTION :: Create a link for the chat window page
