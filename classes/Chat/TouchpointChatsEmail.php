...
{
    public $Show_Chat_Rating        = false;    // TRUE = show form with rating for quality of chat
    ...
    {
        # FUNTION :: Output the chost-closed form - allowing user to send themself an email
