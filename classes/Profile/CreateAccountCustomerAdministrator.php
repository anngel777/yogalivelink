...
class Profile_CreateAccountCustomerAdministrator extends BaseClass
{
    ...
    public $Registration_Email_Template_Id          = 3;        // Email ID to send to customer
    ...
    public $num_free_credits                        = 5;        // (if array says to do this) Number of free credits to add to customer account
    public $num_paid_credits                        = 5;        // (if array says to do this) Number of paid credits to add to customer account
    
    public $Admin_Module_Role                       = 0;        // roles to assign
    public $Admin_Class_Role                        = 0;        // roles to assign
    public $customer_module_roles                   = 36;       // roles to assign
    public $customer_class_roles                    = 0;        // roles to assign
    public $administrator_module_roles              = 0;        // roles to assign
    public $administrator_class_roles               = 0;        // roles to assign
    ...
    public function  __construct()
    {
        ...
        /*
        2012-03-08 - Removed Address 3 line from output
        */
