...
{
    public $Pwd_Min_Length          = 6;        // Minimum number of characters for password
    public $Pwd_Max_Length          = 40;       // Maximum number of characters for password
    public $require_uppercase       = true;     // TRUE = require at least one uppercase letter
    public $require_lowercase       = true;     // TRUE = require at least one lowercase letter
    public $require_numbers         = false;    // TRUE = require at least one number
    public $require_symbols         = false;    // TRUE = require at least one symbol
    ...
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Allow user to reset their password - extending pasword functions from BaseClass',
        );
