<?php
class Profile_InstructorProfileTouchpoints extends BaseClass
{
    ...
    public $get_tp_forms                    = false;    // TRUE = Get any contact forms
    public $get_tp_emails                   = true;     // TRUE = Get emails sent to instructor
    ...
    public function  __construct()
    {
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Get all contact interactions with an instructor',
        );
