...
class Profile_CustomerProfileFreeCredits extends BaseClass
{
    ...
    public $free_credits_email_template_id  = 9;                                        // EMAIL ID to send to customer after credits given
    public $free_credits_link_location      = "Profile_CustomerProfileFreeCredits";     // this class name
    ...
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Used by administrators to give free credits to a customer. If a WHID has been passed in - it will go straight to the form. Otherwise it will ask the administrator to identify the customer - then jump to the form.',
        );
    ...
    {
        if ($this->Show_Array) echo ArrayToStr($FormArray);
