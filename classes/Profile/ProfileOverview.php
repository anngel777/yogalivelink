...
class Profile_ProfileOverview
{
    ...
    public $Is_Instructor                           = false;    // TRUE = person viewing is an instructor
    ...
    public $Show_Profile                            = true;     // TRUE = show the profile section
    public $Show_Session_Search                     = true;     // TRUE = show box going to session search
    public $Show_Logout                             = false;    // TRUE = show a logout box
    public $Show_Email_Subscription                 = false;    // TRUE = show email lists user subscribed to - FUTURE FEATURE
    public $Show_Change_Password                    = true;     // TRUE = show change password box
    public $Show_Instructor_Profile                 = true;     // TRUE = show the profile section - instructor only
    public $Show_Instructor_Checklist               = true;     // TRUE = show the checklist instructor still needs to do
    public $Show_Instructor_Limited_Message         = true;     // TRUE = show if instructor account is limited message
    public $Show_Intake_Forms                       = true;     // TRUE = show box for filling in intake forms
    public $Show_Session_Ratings                    = true;     // TRUE = show if there are sessions instructor hasn't rated
    
    // ---------- NON-MODIFIABLE VARIABLES ----------
    public $WH_ID                               = 0;
    public $Profile_Inactive                    = false;
    public $Ajax_Page_Link                      = '';
    public $Have_Session_Customer_Not_Rated     = false;    // (if gets set) TRUE = Customer has not rated one of the sessions
    ...
    public function  __construct($wh_id=0)
    {
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Shows the customer or instructor profile page with all various sections',
        );
