...
class Sessions_Details extends BaseClass
{
    ...
    public $Show_Array                      = false;        // TRUE = output the results from a database call
    ...
    public function  __construct()
    {
        ...
        $this->ClassInfo = array(
            ...
            'Created'     => '',
            'Version'     => '1.0',
            'Description' => 'Used to show details about a session. Generally for instructors to see who booked a session and what tasks they can do.',
        );
    ...
    {
        # FUNCTION :: Get details about this session
    ...
    {
        # FUNCTION :: Get details about instructor for this session
    ...
    {
        # FUNCTION :: Get details about customer for this session
    ...
    {
        # FUNCTION :: Get the status of the session
    ...
    {
        # FUNCTION :: Show the session checklist - what has been done / not been done
    ...
    {
        # FUNCTION :: Format and output the instructor information
    ...
    {
        # FUNCTION :: Format and output the customer information
    ...
    {
        # FUNCTION :: Format and output actions that can be done to this session
