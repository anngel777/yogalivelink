...
class Profile_CustomerProfileOverview
{
    ...
    public function Execute()
    {
        ...
        if ($this->Show_Profile) {
            ...
            $edit_link      = "<a href='#' onclick=\"top.parent.appformCreateOverlay('[T~CPO_002]', getClassExecuteLinkNoAjax('{$eq_CustomerProfileContacts}'), 'apps'); return false;\">[T~CPO_006]</a>";
            $box_profile    = AddBox('[T~CPO_003]', $content, $edit_link) . '<br /><br />';
        }
        ...
        $output = "
        <div class='customer_profile_header_text'>[T~CPO_014]</div>
        <br /><br />
        <div>
