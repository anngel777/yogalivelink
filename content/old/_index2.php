...
Last Updated By: 
       ...
       Filename: index2
    Description: Testing modifications to the website homepage
    
    ** has changes for slideshow timing
    ** has ability to change taglines via URL GET vars
==================================================================================== */
...
$tag1 = (Get('t1'))? Get('t1') : ''; //"Modify URL ==> ;t1=tagline 1";
$tag2 = (Get('t2'))? Get('t2') : ''; //"Modify URL ==> ;t2=tagline 2";
$imgWidth = (Get('i'))? Get('i') : '338';
...
<table width="100%" border="0">
    <tr>
        <td colspan="2" valign="top" >
            <div class="index_header"><b>1-on-1</b> live yoga sessions - just you and your instructor online</div>
    ...
    <tr>
        <td rowspan="2">
            ...
            if (Get('taglines')) {
                ...
                $outputT = " 
                    <div style='text-align:right; padding-right:70px;'>
                        <br /><br />
                        <div class='index_header'>{$tag1}</div>
                        <div class='index_header_sub'>{$tag2}</div>
                        <div style='padding-right:0px;'>
                            <img src='/images/signup_20discount.jpg' alt='' border='0' width='{$imgWidth}'/>
                        </div>
                    </div>
            ...
            <br />
            <div class='index_header' style="font-size:40px;"><a href="/signup" style="color:#A71249;">Get Started Today</a></div>
            
            
            <ul style="font-size:14px; font-family:serif;">            
            <li>Build strength and vitality with 1-on-1 training</li>
            <li>Sessions available most any time</li>
            <li>More affordable than private yoga sessions at a studio</li>
...
$script = <<<SCRIPT
    $('.slideshow').cycle({
        fx:         'fade',
        delay:      1000,       // delay ==> additional delay (in ms) for first transition (hint: can be negative) 
        pause:      1,          // pause ==> 1 = enable pause on hover
        timeout:    4000,       // timeout ==> milliseconds between slide transitions (0 to disable auto advance)
        speed:      500,        // speed of the transition (any valid fx speed value) 
        slideExpr: 'img',       // images only
