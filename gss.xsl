...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template name="siteindexTable">
    <h3>This sitemap index file was created by Derek M Bachmann.</h3>          
  ...
  <xsl:template name="sitemapTable">
    <h3>This Google Sitemap file was created by Derek M Bachmann.</h3>          
  ...
  <xsl:template match="sitemap:url">
    <tr>  
      <td>
        ...
        <a href="../../Downloads/%7B$sitemapURL%7D" target="_blank" ref="nofollow"><xsl:value-of select="$sitemapURL"></xsl:value-of></a>
      </td>
  ...
  <xsl:template match="sitemap:sitemap">
    <tr>  
      <td>        
        <xsl:variable name="sitemapURL"><xsl:value-of select="sitemap:loc"/></xsl:variable>  
        <a href="../../Downloads/%7B$sitemapURL%7D"><xsl:value-of select="$sitemapURL"></xsl:value-of></a>
      </td>
      <td><xsl:value-of select="sitemap:lastmod"/></td>
    </tr>  
  </xsl:template>  
